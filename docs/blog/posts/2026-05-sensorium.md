...
These considerations suggest a more measured conclusion than the earlier essays. It would be too strong to claim that embodiment adds nothing. On the contrary, it introduces elements that were previously absent: situatedness, temporal continuity, and a form of egocentric organisation. These are not trivial additions. They move artificial systems closer to the conditions under which biological cognition operates.

At the same time, it is not clear that these developments are sufficient to produce what we ordinarily associate with a point of view in the fuller sense. The system may be centred in a geometric or functional manner without there being anything that occupies that centre. It may have a perspective in the sense of organising information relative to itself, without that perspective being lived.

### Refining the Frontier

What we are left with, then, is a system that is no longer entirely detached from the world, but not yet evidently a subject within it. It can be located in space and time, can act and perceive, and can adapt to its environment. But whether the world is present to it in any meaningful sense remains an open question.

The earlier concern was that models trained purely on description lack any contact with reality. That concern weakens once perception and embodiment are introduced. The problem is no longer the absence of contact, but the absence of anything that turns contact into experience.

If artificial systems are to move beyond this point, the challenge will not be to add further modalities or increase representational capacity. It will be to understand what, if anything, transforms a system that is merely situated into one for which the world is actually there.

The Sensorium, in this sense, does not resolve the difficulty. It refines it.
