...
``` javascript
// Colour codes for districts based on Literacy Rates
...
```
The code above is used in the cartogram at [**GitHub**](https://gist.github.com/anilnairxyz/11190f144a89b54c6698699f3a83b315)
